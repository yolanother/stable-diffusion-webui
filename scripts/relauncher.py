...
while True:
    if n == 0:
        ...
        run_process(f"python -u scripts/webui.py {common_arguments} {inbrowser_argument} {additional_arguments}")
        
    else:
        print(f'\tRelaunch count: {n}')
        print('Relauncher: Launching...')
        run_process(f"python -u scripts/webui.py {common_arguments} {additional_arguments}")
